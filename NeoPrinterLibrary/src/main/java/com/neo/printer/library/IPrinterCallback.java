...
public interface IPrinterCallback extends android.os.IInterface
{
  ...
  {
    private static final String DESCRIPTOR = "com.neo.printer.library.IPrinterCallback";
    ...
    /**
     * Cast an IBinder object into an com.neo.printer.library.IPrinterCallback interface,
