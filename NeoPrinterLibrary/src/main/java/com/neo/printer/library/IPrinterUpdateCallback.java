...
public interface IPrinterUpdateCallback extends android.os.IInterface
{
  ...
  {
    private static final String DESCRIPTOR = "com.neo.printer.library.IPrinterUpdateCallback";
    ...
    /**
     * Cast an IBinder object into an com.neo.printer.library.IPrinterUpdateCallback interface,
