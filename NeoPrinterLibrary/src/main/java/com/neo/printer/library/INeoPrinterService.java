...
public interface INeoPrinterService extends android.os.IInterface
{
  ...
  public static abstract class Stub extends android.os.Binder implements INeoPrinterService
  {
    ...
    static final int TRANSACTION_exitPrinterBuffer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
    static final int TRANSACTION_commitPrinterBuffer = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
    static final int TRANSACTION_setDebugLogLevel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
    static final int TRANSACTION_setDebugLogSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
    static final int TRANSACTION_setDebugLogModule = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
    static final int TRANSACTION_getDebugLogState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
    static final int TRANSACTION_printAndLineFeed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
    static final int TRANSACTION_printAndFeedPaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
    static final int TRANSACTION_printAndQuitPaper = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
    static final int TRANSACTION_partialCut = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
    static final int TRANSACTION_fullCut = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
    static final int TRANSACTION_setFontMultiple = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
    static final int TRANSACTION_setFontBold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
    static final int TRANSACTION_setFontAntiWhite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
    static final int TRANSACTION_setFontItalic = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
    static final int TRANSACTION_setFontUnderline = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
    static final int TRANSACTION_setFontRotate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
    static final int TRANSACTION_setFontDirection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
    static final int TRANSACTION_setFontLineSpacing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
    static final int TRANSACTION_setFontChineseSpace = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
    static final int TRANSACTION_setFontCharSpace = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
    static final int TRANSACTION_setFontChineseSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
    static final int TRANSACTION_setFontCharSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
    static final int TRANSACTION_setFontChineseMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
    static final int TRANSACTION_setFontCountryCode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
    static final int TRANSACTION_setFontCodepage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
    static final int TRANSACTION_getFontCountryCode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
    static final int TRANSACTION_getFontCodepage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
    static final int TRANSACTION_printText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
    static final int TRANSACTION_printTextWithAli = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
    static final int TRANSACTION_printTextWithEncode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
    static final int TRANSACTION_setCodeAlignment = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
    static final int TRANSACTION_setTextBitmapTypeface = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
    static final int TRANSACTION_setTextBitmapSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
    static final int TRANSACTION_setTextBitmapStyle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
    static final int TRANSACTION_setTextBitmapStrikeThru = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
    static final int TRANSACTION_setTextBitmapUnderline = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
    static final int TRANSACTION_setTextBitmapLineSpacing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
    static final int TRANSACTION_setTextBitmapLetterSpacing = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
    static final int TRANSACTION_setTextBitmapAntiWhite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
    static final int TRANSACTION_printTextBitmap = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
    static final int TRANSACTION_printTextBitmapWithAli = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
    static final int TRANSACTION_printBitmap = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
    static final int TRANSACTION_printBitmapWithAlign = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
    static final int TRANSACTION_printMultiBitmap = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
    static final int TRANSACTION_printMultiBitmapWithAlign = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
    static final int TRANSACTION_printColumnsText = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
    static final int TRANSACTION_printColumnsString = (android.os.IBinder.FIRST_CALL_TRANSACTION + 73);
    static final int TRANSACTION_setBarCodeWidth = (android.os.IBinder.FIRST_CALL_TRANSACTION + 74);
    static final int TRANSACTION_setBarCodeHeight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 75);
    static final int TRANSACTION_setBarCodeContentPrintPos = (android.os.IBinder.FIRST_CALL_TRANSACTION + 76);
    static final int TRANSACTION_printBarCodeWithFull = (android.os.IBinder.FIRST_CALL_TRANSACTION + 77);
    static final int TRANSACTION_printBarCode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 78);
    static final int TRANSACTION_printBarCodeWithAlign = (android.os.IBinder.FIRST_CALL_TRANSACTION + 79);
    static final int TRANSACTION_setQrCodeSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 80);
    static final int TRANSACTION_setQrCodeErrorCorrectionLev = (android.os.IBinder.FIRST_CALL_TRANSACTION + 81);
    static final int TRANSACTION_setLeftMargin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 82);
    static final int TRANSACTION_printQRCodeWithFull = (android.os.IBinder.FIRST_CALL_TRANSACTION + 83);
    static final int TRANSACTION_printQrCode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 84);
    static final int TRANSACTION_printQrCodeWithAlign = (android.os.IBinder.FIRST_CALL_TRANSACTION + 85);
    static final int TRANSACTION_setDoubleQRSize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 86);
    static final int TRANSACTION_setDoubleQR1MarginLeft = (android.os.IBinder.FIRST_CALL_TRANSACTION + 87);
    static final int TRANSACTION_setDoubleQR2MarginLeft = (android.os.IBinder.FIRST_CALL_TRANSACTION + 88);
    static final int TRANSACTION_setDoubleQR1Level = (android.os.IBinder.FIRST_CALL_TRANSACTION + 89);
    static final int TRANSACTION_setDoubleQR2Level = (android.os.IBinder.FIRST_CALL_TRANSACTION + 90);
